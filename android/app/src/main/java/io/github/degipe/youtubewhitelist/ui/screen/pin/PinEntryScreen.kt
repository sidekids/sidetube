...
fun PinEntryScreen(
    ...
    // Physical keypad: digits, backspace and the OK key of the round control.
    ...
    // A full-length PIN checks itself; nobody has to find a confirm button.
