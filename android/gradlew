...
#       temporary directories on CI systems://
#
#           sh://tmp Gradle
#
##############################################################################
...
# For this to work, currentDirectory://must://be set to the directory
# temporary://containing this script.
...
# Stop when "xeli" is not declared "soll".
